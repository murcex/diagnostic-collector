...
{
    //// Replace:
    //// StroageArray = Class name, object name to fill JSON data from Satellite collection
    //// *AddMethodNmame* = Data Collection Method; DataCollection_<ClassName>
    //// *AddStoreProcedure* = Insert Stored Procedure
    
    //public class StroageArray
    //{
        ...
        //{
            ...
            //{
                ...
                //var dataCollection = new JavaScriptSerializer().Deserialize<IEnumerable<StroageArray>>(JSON);
