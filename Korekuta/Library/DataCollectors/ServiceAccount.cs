    ...
    public class ServiceAccount
    {
        ...
        public static void DataCollection(string url, string connectionString)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                var dataCollection = new JavaScriptSerializer().Deserialize<IEnumerable<ServiceAccount>>(JSON);
                ...
                foreach (var item in dataCollection)
                {
                    using (SqlConnection connection = new SqlConnection(connectionString))
                    {
                        ...
                        SqlCommand command = new SqlCommand("usp_ServiceAccount_Insert", connection);
                        ...
                        command.Parameters.AddWithValue("nvc_serviceaccount", item.nvc_serviceaccount);
                        command.Parameters.AddWithValue("b_enabled", item.b_enabled);
                        command.Parameters.AddWithValue("nvc_domain", item.nvc_domain);
