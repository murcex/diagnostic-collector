...
namespace Sensor
{
    class Collection
    {
        public static void CollectIP(Target hostname, Sensor sensor)
        {
        ...
        public static void CollectHTTPRequest(Target target, Sensor sensor, Stopwatch timer)
        {
        ...
        public static void CollectHTTPRequestTesting(Target target)
        {
